...
export default function Navbar() {
  ...
  return (
    <>
      <div className="z-50 fixed top-0 z-[1000] bg-transparent backdrop-filter backdrop-blur-xl bg-opacity-40 p-4 md:p-8 lg:px-32 w-full md:flex md:items-center md:justify-between">
        <div className="flex items-center justify-between">
          <span className="flex cursor-pointer items-center" >
            <Link href="/"><img className="h-10 mr-4" src="./logo.png" alt="pro" /></Link>
          </span>
          <span onClick={toggle}>
